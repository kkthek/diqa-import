						...
						"custom.combobox",
						{
							...
							_createAutocomplete : function() {
								...
								this.input = $("<input>")
										...
										.attr("title", "")
										.addClass(
												"custom-combobox-input ui-widget ui-widget-content ui-corner-left")
										.autocomplete({
											delay : 0,
											minLength : 0,
							...
							_createShowAllButton : function() {
								...
								a.html('<span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-s"></span><span class="ui-button-text">x</span>');
							},
							...
							_removeIfInvalid : function(event, ui) {
								...
								if (newNeeded) {
									this.element.append($('<option>').attr('value',value).attr('selected','selected'));
								}
